...
const NavbarDesktop: React.FC = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 w-full border-b border-white/10 bg-primary/95 backdrop-blur-md transition-colors duration-300 hidden lg:block text-white">
          ...
          <nav className="flex items-center gap-2" aria-label="Main navigation">
              ...
              >
                ...
                <span
                  className={`material-symbols-outlined text-[18px] transition-transform duration-300 ${
                    isServicesOpen ? 'rotate-180 text-secondary' : ''
                  }`}
                  aria-hidden="true"
                >
                  expand_more
                  ...
                  >
                    <div className="grid grid-cols-2 gap-2">
                      {practiceAreaLinks.map((link) => (
                        ...
                        >
                          <span className="material-symbols-outlined text-primary text-[18px] mt-0.5" aria-hidden="true">
                            chevron_right
                          </span>
            ...
            <div className="relative" ref={aboutRef}>
              ...
              >
                ...
                <span
                  className={`material-symbols-outlined text-[18px] transition-transform duration-300 ${
                    isAboutOpen ? 'rotate-180 text-secondary' : ''
                  }`}
                  aria-hidden="true"
                >
                  expand_more
            ...
            <Link to={`/${lng}/insights`} className={navLinkClass(`/${lng}/insights`)}>
              {t('nav.insights')}
            </Link>
